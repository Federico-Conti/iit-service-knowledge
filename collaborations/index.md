...
| Collaborazione | Descrizione | Link |
|---|---|---|
| RAG Camera dei deputati | Chatbot per la consultazione di documenti parlamentari multimodali | [Apri](#poc-camera-dei-deputati) |
| Icub Story Telling | Storytelling collaborativo e multimodale tra utente e robot iCub | [Apri](#icub-story-telling) |
...
<section class="media-carousel" aria-label="Materiali della collaborazione ICT–HSP">
  <div class="media-carousel__track">
    <figure class="media-carousel__slide" id="hsp-media-1">
      <img src="{{ '/images/hsp-collab.JPG' | relative_url }}" alt="Sessione di storytelling collaborativo con iCub" loading="lazy">
    </figure>
